...
/// directory. If you need ThinWedge to work from such a checkout simply pass the
...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/ThinWedge.git",
            "ssh://git@github.com/openai/thinwedge.git",
            "ssh://git@github.com:22/OpenAI/ThinWedge.git",
            "https://github.com/openai/thinwedge.git",
            "https://github.com:443/openai/thinwedge.git",
            "https://token@github.com/openai/thinwedge/",
            "github.com/OpenAI/ThinWedge.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/thinwedge".to_string())
            );
        }
    }
