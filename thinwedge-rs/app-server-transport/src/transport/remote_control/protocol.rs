...
mod tests {
    ...
    fn normalize_remote_control_url_accepts_chatgpt_https_urls() {
        ...
        assert_eq!(
            normalize_remote_control_url("https://remote-control.chatgpt.com/backend-api")
                .expect("chatgpt.com subdomain URL should normalize"),
            RemoteControlTarget {
                websocket_url:
                    "wss://remote-control.chatgpt.com/backend-api/wham/remote/control/server"
                        .to_string(),
                enroll_url:
                    "https://remote-control.chatgpt.com/backend-api/wham/remote/control/server/enroll"
                        .to_string(),
                refresh_url:
                    "https://remote-control.chatgpt.com/backend-api/wham/remote/control/server/refresh"
                        .to_string(),
                pair_url:
                    "https://remote-control.chatgpt.com/backend-api/wham/remote/control/server/pair"
                        .to_string(),
                pair_status_url:
                    "https://remote-control.chatgpt.com/backend-api/wham/remote/control/server/pair/status"
                        .to_string(),
            }
        );
    }
