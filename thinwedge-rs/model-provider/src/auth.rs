...
struct AgentIdentityAuthProvider {
    auth: thinwedge_login::auth::AgentIdentityAuth,
}
...
fn bearer_auth_for_provider(
    provider: &ModelProviderInfo,
) -> thinwedge_protocol::error::Result<Option<BearerAuthProvider>> {
...
/// Builds request-header auth for a first-party ThinWedge auth snapshot.
pub fn auth_provider_from_auth(auth: &ThinWedgeAuth) -> SharedAuthProvider {
    match auth {
