        ...
        ToolSpec::Function(ResponsesApiTool {
            ...
            parameters: JsonSchema::object(BTreeMap::from([
                    ...
                    (
                        "tool_id".to_string(),
                        JsonSchema::string(Some(
                                "Connector or plugin id to suggest. Must be one of: slack@thinwedge-curated, github."
                                    .to_string(),
                            ),),
                    ),
                    (
...
#[test]
fn filter_tool_suggest_discoverable_tools_for_thinwedge_tui_omits_plugins() {
