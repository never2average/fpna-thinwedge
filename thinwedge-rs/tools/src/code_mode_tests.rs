...
fn tool_spec_to_code_mode_tool_definition_returns_augmented_nested_tools() {
    ...
    assert_eq!(
        ...
        Some(thinwedge_code_mode::ToolDefinition {
            name: "apply_patch".to_string(),
...
```"#
                .to_string(),
            kind: thinwedge_code_mode::CodeModeToolKind::Freeform,
            input_schema: None,
            output_schema: None,
        })
    );
...
fn create_code_mode_tool_matches_expected_spec() {
    let enabled_tools = vec![thinwedge_code_mode::ToolDefinition {
        name: "update_plan".to_string(),
        tool_name: ToolName::plain("update_plan"),
        description: "Update the plan".to_string(),
        kind: thinwedge_code_mode::CodeModeToolKind::Function,
        input_schema: None,
        output_schema: None,
    }];
