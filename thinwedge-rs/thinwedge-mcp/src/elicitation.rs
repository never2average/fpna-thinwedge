...
//!
//! RMCP clients call into this module when a server asks ThinWedge to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a ThinWedge protocol event
...
use thinwedge_protocol::approvals::ElicitationRequest;
...
use thinwedge_rmcp_client::SendElicitation;
