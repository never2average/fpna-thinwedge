...
const THINWEDGE_CONNECTORS_TOKEN_ENV_VAR: &str = "THINWEDGE_CONNECTORS_TOKEN";
...
/// `thinwedge-mcp` crate needs to construct server transports, enforce MCP
...
pub struct McpConfig {
    ...
    /// Optional path to `thinwedge-linux-sandbox` for sandboxed MCP tool execution.
