...
pub type PluginManifest = thinwedge_plugin::manifest::PluginManifest<AbsolutePathBuf>;
pub type PluginManifestHooks = thinwedge_plugin::manifest::PluginManifestHooks<AbsolutePathBuf>;
pub type PluginManifestInterface =
    thinwedge_plugin::manifest::PluginManifestInterface<AbsolutePathBuf>;
pub type PluginManifestPaths = thinwedge_plugin::manifest::PluginManifestPaths<AbsolutePathBuf>;
...
mod tests {
    ...
    use thinwedge_plugin::PluginProvider;
    use thinwedge_plugin::ResolvedPlugin;
    ...
    fn write_manifest(plugin_root: &Path, version: Option<&str>, interface: &str) {
        fs::create_dir_all(plugin_root.join(".thinwedge-plugin")).expect("create manifest dir");
        let version = version
