  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "thinwedge-curated".to_string())
                .unwrap(),
  ...
  "plugins": [
    {{
      ...
      "source": {{
        ...
        assert_eq!(
            err.to_string(),
            "plugin `remote-plugin` was not found in marketplace `thinwedge-curated`"
        );
    }
}
...
fn find_marketplace_plugin_reports_missing_plugin() {
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `thinwedge-curated`"
    );
}
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "plugins": [
    {
      ...
      "policy": {
        ...
        "products": ["THINWEDGE", "CHATGPT", "ATLAS"]
      },
      "category": "Design"
    }
  ]
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::ThinWedge, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
...
fn find_marketplace_plugin_skips_invalid_local_paths() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `local-plugin` was not found in marketplace `thinwedge-curated`"
    );
}
...
fn find_installable_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `thinwedge-curated`"
    );
}
...
fn find_installable_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `thinwedge-curated`"
    );
}
