...
pub type LoadedPlugin = thinwedge_plugin::LoadedPlugin<thinwedge_config::McpServerConfig>;
pub type PluginLoadOutcome = thinwedge_plugin::PluginLoadOutcome<thinwedge_config::McpServerConfig>;
