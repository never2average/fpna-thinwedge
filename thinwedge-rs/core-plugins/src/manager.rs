...
use crate::loader::configured_curated_plugin_ids_from_thinwedge_home;
...
use thinwedge_config::clear_user_plugin;
use thinwedge_config::set_user_plugin_enabled;
use thinwedge_config::types::PluginConfig;
use thinwedge_core_skills::SkillMetadata;
use thinwedge_core_skills::config_rules::SkillConfigRules;
use thinwedge_core_skills::config_rules::skill_config_rules_from_stack;
use thinwedge_hooks::plugin_hook_declarations;
...
fn project_plugin_load_outcome_for_auth(
    ...
    let apps_route_available = auth_mode.is_some_and(AuthMode::uses_thinwedge_backend);
...
impl PluginsManager {
    ...
    async fn uninstall_plugin_id(&self, plugin_id: PluginId) -> Result<(), PluginUninstallError> {
        ...
        clear_user_plugin(&self.thinwedge_home, plugin_id.as_key())
            .await
            .map_err(anyhow::Error::from)?;
            ...
            tokio::spawn(async move {
                ...
                if config_for_remote_sync.remote_plugin_enabled {
                    match crate::remote::fetch_and_cache_global_remote_plugin_catalog(
                        manager.thinwedge_home.as_path(),
