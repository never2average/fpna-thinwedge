...
//! "leave the old title alone" or "clear the title ThinWedge last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title ThinWedge manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before ThinWedge started managing the title.
