...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for ThinWedge",
            ...
            SlashCommand::App => "continue this session in ThinWedge Desktop",
            ...
            SlashCommand::Personality => "choose a communication style for ThinWedge",
            ...
            SlashCommand::Logout => "log out of ThinWedge",
