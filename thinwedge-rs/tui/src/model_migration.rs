...
mod tests {
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5.1-thinwedge-mini",
                "gpt-5.1-thinwedge-max",
                /*model_link*/ None,
                Some(
                    "Upgrade to gpt-5.2-thinwedge for the latest and greatest agentic coding model."
                        .to_string(),
                ),
                /*migration_markdown*/ None,
                "gpt-5.1-thinwedge-max".to_string(),
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.thinwedge.com/models/gpt-5.1".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-5.1".to_string(),
    ...
    #[test]
    fn prompt_snapshot_gpt5_thinwedge() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-thinwedge",
                "gpt-5.1-thinwedge-max",
                Some("https://www.thinwedge.com/models/gpt-5.1-thinwedge-max".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-5.1-thinwedge-max".to_string(),
                Some("ThinWedge-optimized flagship for deep and fast reasoning.".to_string()),
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_thinwedge", terminal.backend());
    }

    #[test]
    fn prompt_snapshot_gpt5_thinwedge_mini() {
        let backend = VT100Backend::new(/*width*/ 60, /*height*/ 22);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 22));
        ...
        let screen = ModelMigrationScreen::new(
            FrameRequester::test_dummy(),
            migration_copy_for_models(
                "gpt-5-thinwedge-mini",
                "gpt-5.1-thinwedge-mini",
                Some("https://www.thinwedge.com/models/gpt-5.1-thinwedge-mini".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_thinwedge_mini", terminal.backend());
    }
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.thinwedge.com/models/gpt-new".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-new".to_string(),
