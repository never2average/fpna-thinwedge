...
pub(crate) enum AppEvent {
    ...
    /// Open the current thread in ThinWedge Desktop.
    OpenDesktopThread {
        thread_id: ThreadId,
    },
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<thinwedge_app_server_protocol::HooksListResponse, String>,
    },
