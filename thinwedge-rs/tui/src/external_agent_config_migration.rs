...
mod tests {
    ...
    use thinwedge_app_server_protocol::PluginsMigration;
    use thinwedge_app_server_protocol::SessionMigration;
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.thinwedge/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(thinwedge_app_server_protocol::MigrationDetails {
