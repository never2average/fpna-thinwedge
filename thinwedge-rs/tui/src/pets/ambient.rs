//! Ambient terminal rendering for the ThinWedge companion.
//!
...
impl AmbientPet {
    ...
    /// THINWEDGE_HOME cache, and records the terminal protocol support snapshot used
...
mod tests {
    ...
    #[test]
    fn notification_labels_match_thinwedge_app_vocabulary() {
