//! Built-in pet catalog ported from the ThinWedge App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "thinwedge",
        display_name: "ThinWedge",
        description: "The original ThinWedge companion",
        spritesheet_file: "thinwedge-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
