...
use thinwedge_app_server_protocol::HookOutputEntry;
use thinwedge_app_server_protocol::HookOutputEntryKind;
use thinwedge_app_server_protocol::HookRunStatus;
use thinwedge_app_server_protocol::HookRunSummary;
...
mod tests {
    ...
    fn completed_hook_multiline_context_preserves_display_and_raw_lines() {
        ...
        let expected = vec![
            ...
            "".to_string(),
            "    Source: ThinWedge compaction".to_string(),
