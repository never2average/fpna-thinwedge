...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "ThinWedge app name",
            ...
            TerminalTitleItem::ThinWedgeVersion => "ThinWedge application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::ThinWedgeVersion => Some(StatusSurfacePreviewItem::ThinWedgeVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::ThinWedgeVersion,
