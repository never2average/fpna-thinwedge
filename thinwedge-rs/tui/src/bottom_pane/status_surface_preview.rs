...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "thinwedge",
            ...
            StatusSurfacePreviewItem::ThinWedgeVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-thinwedge",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-thinwedge medium",
