...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: ThinWedge is rebuilding normal terminal scrollback, not an
...
use thinwedge_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
