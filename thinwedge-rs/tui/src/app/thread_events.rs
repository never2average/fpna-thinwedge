...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<thinwedge_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use thinwedge_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use thinwedge_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use thinwedge_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use thinwedge_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use thinwedge_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use thinwedge_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use thinwedge_app_server_protocol::HookScope as AppServerHookScope;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            thinwedge_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: thinwedge_app_server_protocol::McpServerStartupState::Failed,
