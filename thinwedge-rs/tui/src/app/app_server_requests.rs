                    ...
                    Ok::<AppServerRequestResolution, String>(AppServerRequestResolution {
                        ...
                        result: serde_json::to_value(McpServerElicitationRequestResponse {
                            action: match decision {
                                thinwedge_protocol::approvals::ElicitationAction::Accept => {
                                    McpServerElicitationAction::Accept
                                }
                                thinwedge_protocol::approvals::ElicitationAction::Decline => {
                                    McpServerElicitationAction::Decline
                                }
                                thinwedge_protocol::approvals::ElicitationAction::Cancel => {
...
mod tests {
    ...
    use thinwedge_app_server_protocol::PermissionGrantScope;
    use thinwedge_app_server_protocol::PermissionsRequestApprovalParams;
    use thinwedge_app_server_protocol::PermissionsRequestApprovalResponse;
    use thinwedge_app_server_protocol::RequestId as AppServerRequestId;
    use thinwedge_app_server_protocol::ServerRequest;
    use thinwedge_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: thinwedge_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: thinwedge_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: thinwedge_app_server_protocol::GrantedPermissionProfile {
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: thinwedge_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn same_turn_user_input_answers_resolve_app_server_requests_fifo() {
        ...
        let response = thinwedge_protocol::request_user_input::RequestUserInputResponse {
            answers: HashMap::new(),
        };
