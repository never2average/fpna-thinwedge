...
pub(super) async fn fetch_account_token_activity(
    request_handle: AppServerRequestHandle,
) -> Result<thinwedge_app_server_protocol::GetAccountTokenUsageResponse> {
...
pub(super) async fn send_add_credits_nudge_email(
    request_handle: AppServerRequestHandle,
    credit_type: AddCreditsNudgeCreditType,
) -> Result<thinwedge_app_server_protocol::AddCreditsNudgeEmailStatus> {
    let request_id = RequestId::String(format!("add-credits-nudge-{}", Uuid::new_v4()));
    let response: thinwedge_app_server_protocol::SendAddCreditsNudgeEmailResponse = request_handle
...
pub(super) type McpInventoryMaps = (
    HashMap<String, thinwedge_protocol::mcp::Tool>,
    HashMap<String, Vec<thinwedge_protocol::mcp::Resource>>,
    HashMap<String, Vec<thinwedge_protocol::mcp::ResourceTemplate>>,
