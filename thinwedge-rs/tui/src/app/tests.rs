    ...
    assert_eq!(
        ...
        vec![
            ...
            thinwedge_protocol::protocol::ReviewDecision::NetworkPolicyAmendment {
                network_policy_amendment: thinwedge_protocol::approvals::NetworkPolicyAmendment {
                    host: "example.com".to_string(),
                    action: thinwedge_protocol::approvals::NetworkPolicyRuleAction::Allow,
                },
            },
...
async fn clear_ui_header_shows_fast_status_for_fast_capable_models() {
    ...
    app.chat_widget
        .set_service_tier(Some(thinwedge_protocol::config_types::ServiceTier::Fast));
...
async fn fresh_session_config_uses_current_service_tier() {
    ...
    assert_eq!(
        config.service_tier,
        Some(thinwedge_protocol::config_types::ServiceTier::Fast)
    );
}
...
async fn backtrack_selection_with_duplicate_history_targets_unique_turn() {
    ...
    app.chat_widget.handle_thinwedge_event(Event {
        id: String::new(),
