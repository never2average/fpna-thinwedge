...
impl ChatWidget {
    ...
    pub(crate) fn has_thinwedge_backend_auth(&self) -> bool {
        self.has_thinwedge_backend_auth
    }
    ...
    pub(crate) fn update_account_state(
        ...
        let account_state_changed = self.status_account_display != status_account_display
            ...
            || self.has_thinwedge_backend_auth != has_thinwedge_backend_auth;
        ...
        self.bottom_pane
            .set_token_activity_command_enabled(has_thinwedge_backend_auth);
    }
