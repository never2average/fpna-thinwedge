...
impl ChatWidget {
    ...
    pub(crate) fn world_writable_warning_details(&self) -> Option<(Vec<String>, usize, bool)> {
        ...
        match thinwedge_windows_sandbox::apply_world_writable_scan_and_denies_for_permissions(
            self.config.thinwedge_home.as_path(),
            cwd.as_path(),
            &env_map,
            &permissions,
    ...
    pub(crate) fn open_windows_sandbox_enable_prompt(
        ...
        header.push(*Box::new(
            Paragraph::new(if allow_unelevated {
                ...
                vec![
                    line!["Your organization requires the default ThinWedge agent sandbox to continue. Set it up to protect your files and control network access."],
    ...
    pub(crate) fn open_windows_sandbox_fallback_prompt(
        ...
        if allow_unelevated {
            ...
            lines.push(line![
                "Your organization requires the default sandbox before ThinWedge can continue."
            ]);
        }
        lines.push(line![
