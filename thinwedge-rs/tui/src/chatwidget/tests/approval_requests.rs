...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    assert_eq!(
        ...
        Some(thinwedge_protocol::protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: thinwedge_protocol::protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
    assert_eq!(
        request.additional_permissions,
        Some(thinwedge_protocol::models::AdditionalPermissionProfile {
