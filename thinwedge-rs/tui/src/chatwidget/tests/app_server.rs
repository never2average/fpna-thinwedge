    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                thinwedge_error_info: Some(ThinWedgeErrorInfo::Other.into()),
                additional_details: None,
            },
            will_retry: true,
            thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                thinwedge_error_info: Some(ThinWedgeErrorInfo::ServerOverloaded.into()),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                thinwedge_error_info: Some(ThinWedgeErrorInfo::CyberPolicy.into()),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
