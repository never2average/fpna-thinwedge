...
fn thread_settings_for_test(
    model: &str,
    thread_id: ThreadId,
) -> thinwedge_app_server_protocol::ThreadSettingsUpdatedNotification {
    thinwedge_app_server_protocol::ThreadSettingsUpdatedNotification {
        thread_id: thread_id.to_string(),
        thread_settings: thinwedge_app_server_protocol::ThreadSettings {
...
fn configured_thread_session(thread_id: ThreadId) -> crate::session_state::ThreadSessionState {
    crate::session_state::ThreadSessionState {
        ...
        thread_name: None,
        model: "gpt-5.3-thinwedge".to_string(),
...
async fn invalid_url_elicitation_is_declined() {
    ...
    chat.handle_elicitation_request_now(
        thinwedge_app_server_protocol::RequestId::Integer(9),
        thinwedge_app_server_protocol::McpServerElicitationRequestParams {
            thread_id: request_thread_id.to_string(),
            turn_id: Some("turn-auth".to_string()),
            server_name: "payments".to_string(),
            request: thinwedge_app_server_protocol::McpServerElicitationRequest::Url {
                meta: None,
    ...
    assert_matches!(
        ...
        Ok(AppEvent::SubmitThreadOp {
            ...
            op: Op::ResolveElicitation {
                server_name,
                request_id: thinwedge_app_server_protocol::RequestId::Integer(9),
...
async fn thread_settings_updated_updates_visible_state_without_transcript() {
    ...
    assert_eq!(
        chat.config_ref()
            ...
            .id,
        thinwedge_protocol::models::BUILT_IN_PERMISSION_PROFILE_READ_ONLY
    );
