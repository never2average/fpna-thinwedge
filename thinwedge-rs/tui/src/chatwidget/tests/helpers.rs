...
pub(super) async fn make_chatwidget_manual(
    ...
    let mut widget = ChatWidget {
        app_event_tx,
        thinwedge_op_target: super::ThinWedgeOpTarget::Direct(op_tx),
        bottom_pane: bottom,
        active_cell: None,
...
pub(super) fn begin_exec_with_source(
    ...
    let parsed_cmd: Vec<ParsedCommand> =
        thinwedge_shell_command::parse_command::parse_command(&command);
            ...
            run: thinwedge_protocol::protocol::HookRunSummary {
                ...
                entries: vec![
                    thinwedge_protocol::protocol::HookOutputEntry {
                        kind: thinwedge_protocol::protocol::HookOutputEntryKind::Warning,
...
fn hook_event_label(event_name: thinwedge_protocol::protocol::HookEventName) -> &'static str {
    match event_name {
        thinwedge_protocol::protocol::HookEventName::PreToolUse => "PreToolUse",
        thinwedge_protocol::protocol::HookEventName::PermissionRequest => "PermissionRequest",
        thinwedge_protocol::protocol::HookEventName::PostToolUse => "PostToolUse",
        thinwedge_protocol::protocol::HookEventName::PreCompact => "PreCompact",
        thinwedge_protocol::protocol::HookEventName::PostCompact => "PostCompact",
        thinwedge_protocol::protocol::HookEventName::SessionStart => "SessionStart",
        thinwedge_protocol::protocol::HookEventName::UserPromptSubmit => "UserPromptSubmit",
