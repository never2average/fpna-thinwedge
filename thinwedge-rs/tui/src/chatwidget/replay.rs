            ...
            if matches!(
                ...
                self.handle_turn_completed_notification(
                    TurnCompletedNotification {
                        ...
                        turn: Turn {
                            id: turn_id,
                            items_view: thinwedge_app_server_protocol::TurnItemsView::NotLoaded,
                            items: Vec::new(),
                            status,
                            error,
                            started_at,
    ...
    pub(super) fn handle_thread_item(
        ...
        match item {
            ...
            item @ ThreadItem::CommandExecution {
                status: thinwedge_app_server_protocol::CommandExecutionStatus::InProgress,
                ..
            ...
            item @ ThreadItem::McpToolCall {
                status: thinwedge_app_server_protocol::McpToolCallStatus::InProgress,
                ..
            ...
            ThreadItem::WebSearch { id, query, action } => {
                ...
                self.on_web_search_end(
                    id,
                    query,
                    action.unwrap_or(thinwedge_app_server_protocol::WebSearchAction::Other),
                );
            }
