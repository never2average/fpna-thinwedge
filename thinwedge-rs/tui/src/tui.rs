...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = thinwedge_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr (optionally keeping raw mode enabled), then re-applies ThinWedge TUI
