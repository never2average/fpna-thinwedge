...
use thinwedge_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
use ts_rs::TS;
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that ThinWedge-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, ThinWedge attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// ThinWedge attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that ThinWedge was previously using.
    ///
