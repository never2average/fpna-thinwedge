...
use thinwedge_protocol::items::FileChangeItem;
use thinwedge_protocol::items::ImageViewItem;
use thinwedge_protocol::items::McpToolCallItem;
use thinwedge_protocol::items::McpToolCallStatus as CoreMcpToolCallStatus;
...
fn thread_sources_round_trip_as_scalar_labels() {
    for (source, label) in [
        ...
        let core_source: thinwedge_protocol::protocol::ThreadSource = source.clone().into();
...
fn core_turn_item_into_thread_item_converts_supported_variants() {
    ...
    let file_change_item = TurnItem::FileChange(FileChangeItem {
        ...
        .into_iter()
        .collect(),
        status: Some(thinwedge_protocol::protocol::PatchApplyStatus::Completed),
        auto_approved: None,
...
fn plugin_share_params_and_response_serialization_use_camel_case_fields() {
    ...
    assert_eq!(
        serde_json::to_value(PluginShareCheckoutResponse {
            ...
            plugin_name: "gmail".to_string(),
            plugin_path,
            marketplace_name: "thinwedge-curated".to_string(),
            marketplace_path,
        ...
        json!({
            ...
            "pluginName": "gmail",
            "pluginPath": plugin_path_json,
            "marketplaceName": "thinwedge-curated",
            "marketplacePath": marketplace_path_json,
            "remoteVersion": "1.2.3",
        }),
    );
...
fn thread_settings_update_params_preserve_field_level_experimental_gates() {
    ...
    let collaboration_mode = ThreadSettingsUpdateParams {
        ...
        collaboration_mode: Some(thinwedge_protocol::config_types::CollaborationMode {
            mode: thinwedge_protocol::config_types::ModeKind::Plan,
