...
pub use thinwedge_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $THINWEDGE_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [thinwedge_protocol::protocol::PatchApplyBeginEvent]
    /// and [thinwedge_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [thinwedge_protocol::protocol::ExecCommandBeginEvent]
    /// and [thinwedge_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
