...
pub enum AuthMode {
    ...
    ChatgptAuthTokens,
    /// Programmatic ThinWedge auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic ThinWedge auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by ThinWedge.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by ThinWedge services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a ThinWedge sandbox.
...
/// Superset of [`thinwedge_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by ThinWedge Cloud.
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    "type": "chatgpt",
                    "thinwedgeStreamlinedLogin": true
                }
            }),
            serde_json::to_value(&request)?,
        );
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: thinwedge_protocol::config_types::CollaborationMode {
