        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_thread(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/CreateThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
                "CreateThread",
            ));
        ...
        pub async fn resume_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/ResumeThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn append_items(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/AppendItems",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn persist_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/PersistThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn flush_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/FlushThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn shutdown_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/ShutdownThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn discard_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/DiscardThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        ) -> std::result::Result<tonic::Response<super::StoredThreadHistory>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/LoadHistory",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        ) -> std::result::Result<tonic::Response<super::StoredThreadResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/ReadThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        ) -> std::result::Result<tonic::Response<super::ListThreadsResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/ListThreads",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        ) -> std::result::Result<tonic::Response<super::StoredThreadResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/UpdateThreadMetadata",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        pub async fn archive_thread(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/ArchiveThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
        ...
        ) -> std::result::Result<tonic::Response<super::StoredThreadResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/thinwedge.thread_store.v1.ThreadStore/UnarchiveThread",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "thinwedge.thread_store.v1.ThreadStore",
...
pub mod thread_store_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            ...
            match req.uri().path() {
                "/thinwedge.thread_store.v1.ThreadStore/CreateThread" => unary_service!(
                    CreateThreadSvc,
                    super::CreateThreadRequest,
                    super::Empty,
                    create_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/ResumeThread" => unary_service!(
                    ResumeThreadSvc,
                    super::ResumeThreadRequest,
                    super::Empty,
                    resume_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/AppendItems" => unary_service!(
                    AppendItemsSvc,
                    super::AppendThreadItemsRequest,
                    super::Empty,
                    append_items
                ),
                "/thinwedge.thread_store.v1.ThreadStore/PersistThread" => unary_service!(
                    PersistThreadSvc,
                    super::ThreadIdRequest,
                    super::Empty,
                    persist_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/FlushThread" => unary_service!(
                    FlushThreadSvc,
                    super::ThreadIdRequest,
                    super::Empty,
                    flush_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/ShutdownThread" => unary_service!(
                    ShutdownThreadSvc,
                    super::ThreadIdRequest,
                    super::Empty,
                    shutdown_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/DiscardThread" => unary_service!(
                    DiscardThreadSvc,
                    super::ThreadIdRequest,
                    super::Empty,
                    discard_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/LoadHistory" => unary_service!(
                    LoadHistorySvc,
                    super::LoadThreadHistoryRequest,
                    super::StoredThreadHistory,
                    load_history
                ),
                "/thinwedge.thread_store.v1.ThreadStore/ReadThread" => unary_service!(
                    ReadThreadSvc,
                ...
                "/thinwedge.thread_store.v1.ThreadStore/UpdateThreadMetadata" => unary_service!(
                    UpdateThreadMetadataSvc,
                    super::UpdateThreadMetadataRequest,
                    super::StoredThreadResponse,
                    update_thread_metadata
                ),
                "/thinwedge.thread_store.v1.ThreadStore/ArchiveThread" => unary_service!(
                    ArchiveThreadSvc,
                    super::ArchiveThreadRequest,
                    super::Empty,
                    archive_thread
                ),
                "/thinwedge.thread_store.v1.ThreadStore/UnarchiveThread" => unary_service!(
                    UnarchiveThreadSvc,
                    super::ArchiveThreadRequest,
                    super::StoredThreadResponse,
                    unarchive_thread
    ...
    pub const SERVICE_NAME: &str = "thinwedge.thread_store.v1.ThreadStore";
