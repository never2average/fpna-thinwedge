...
pub(super) async fn list_rollout_threads(
    state_db: Option<thinwedge_rollout::StateDbHandle>,
    config: &RolloutConfig,
    default_model_provider_id: &str,
    params: &ListThreadsParams,
    cursor: Option<&thinwedge_rollout::Cursor>,
    sort_key: thinwedge_rollout::ThreadSortKey,
    sort_direction: thinwedge_rollout::SortDirection,
) -> ThreadStoreResult<thinwedge_rollout::ThreadsPage> {
