//! Schema-heavy configuration TOML types used by ThinWedge.
...
pub struct ConfigToml {
    ...
    /// sanctioned by ThinWedge will likely degrade model performance.
    ...
    /// directories for `.thinwedge` folders. Defaults to [".git"] when unset.
    #[serde(default)]
