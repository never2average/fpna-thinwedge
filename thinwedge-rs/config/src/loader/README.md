...
This module is the canonical place to **load and describe ThinWedge configuration layers** (user config, CLI/session overrides, managed config, and MDM-managed preferences) and to produce:
...
- `load_config_layers_state(fs, thinwedge_home, cwd_opt, cli_overrides, overrides, cloud_requirements, thread_config_loader) -> ConfigLayerStack`
- `ConfigLayerStack`
