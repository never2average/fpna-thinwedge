...
pub const THINWEDGE_THREAD_ID_ENV_VAR: &str = "THINWEDGE_THREAD_ID";
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("AppData", "C:\\Users\\thinwedge\\AppData\\Roaming"),
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\thinwedge\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/thinwedge".to_string()),
