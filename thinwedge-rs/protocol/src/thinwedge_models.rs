//! Shared model metadata types exchanged between ThinWedge services and clients.
//!
...
/// See https://platform.thinwedge.com/docs/guides/reasoning?api-mode=responses#get-started-with-reasoning
#[derive(
    Debug,
    Serialize,
    Deserialize,
...
/// Metadata describing a ThinWedge-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the ThinWedge backend `/models` endpoint.
