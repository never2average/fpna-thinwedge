...
//! `schemars`) so they can be embedded in ThinWedge's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `thinwedge-protocol` so other crates can convert
