...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_event_as_notification(
        ...
        self.send_notification(OutgoingNotification {
            method: "thinwedge/event".to_string(),
...
// Additional mcp-specific data to be added to a [`thinwedge_protocol::protocol::Event`] as notification.params._meta
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id: thinwedge_protocol::SessionId::new(),
                thread_id,
                forked_from_id: None,
        ...
        assert_eq!(method, "thinwedge/event");
