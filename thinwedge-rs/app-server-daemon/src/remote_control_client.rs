...
use thinwedge_app_server_protocol::RemoteControlDisableParams;
use thinwedge_app_server_protocol::RemoteControlDisableResponse;
use thinwedge_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<thinwedge_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_THINWEDGE_HOME: &str = "/tmp/thinwedge-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "thinwedge_app_server/1.2.3",
                    "thinwedgeHome": TEST_THINWEDGE_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
