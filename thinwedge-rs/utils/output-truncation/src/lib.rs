//! Helpers for truncating tool and exec output using [`TruncationPolicy`](thinwedge_protocol::protocol::TruncationPolicy).

use thinwedge_protocol::models::FunctionCallOutputContentItem;
pub use thinwedge_utils_string::approx_bytes_for_tokens;
pub use thinwedge_utils_string::approx_token_count;
pub use thinwedge_utils_string::approx_tokens_from_byte_count;
use thinwedge_utils_string::truncate_middle_chars;
use thinwedge_utils_string::truncate_middle_with_token_budget;

pub use thinwedge_protocol::protocol::TruncationPolicy;
