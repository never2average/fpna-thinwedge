# thinwedge-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and ThinWedge did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust ThinWedge on it. Feel free to update the documentation as you
modify the code
...
```rust
use thinwedge_utils_stream_parser::CitationStreamParser;
use thinwedge_utils_stream_parser::StreamTextParser;
...
```rust
use thinwedge_utils_stream_parser::CitationStreamParser;
use thinwedge_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), thinwedge_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use thinwedge_utils_stream_parser::InlineHiddenTagParser;
use thinwedge_utils_stream_parser::InlineTagSpec;
use thinwedge_utils_stream_parser::StreamTextParser;
