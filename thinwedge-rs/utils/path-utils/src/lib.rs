//! Path normalization, symlink resolution, and atomic writes shared across ThinWedge crates.
...
/// Compare paths after applying ThinWedge's filesystem normalization.
///
