...
const DEFAULT_PERSONALITY_HEADER: &str = "You are ThinWedge, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
fn local_personality_messages_for_slug(slug: &str) -> Option<ModelMessages> {
    match slug {
        "gpt-5.2-thinwedge" | "exp-thinwedge-personality" => Some(ModelMessages {
