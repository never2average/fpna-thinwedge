...
use thinwedge_apply_patch::AppliedPatchDelta;
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = thinwedge_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::ThinWedge(ThinWedgeErr::Sandbox(
                SandboxErr::Denied {
