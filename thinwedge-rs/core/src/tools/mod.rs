...
) -> thinwedge_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => thinwedge_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => thinwedge_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => thinwedge_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => thinwedge_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => thinwedge_tools::ToolUserShellType::Cmd,
    }
}
