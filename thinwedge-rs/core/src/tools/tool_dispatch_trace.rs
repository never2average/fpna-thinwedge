...
//!
//! `thinwedge-rollout-trace` owns the event schema and writer behavior. This module
...
use thinwedge_rollout_trace::ToolDispatchResult;
use thinwedge_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        thinwedge_turn_id: invocation.turn.sub_id.clone(),
