...
use thinwedge_tools::ToolHandlerKind;
use thinwedge_tools::ToolName;
use thinwedge_tools::ToolNamespace;
use thinwedge_tools::ToolRegistryPlanDeferredTool;
use thinwedge_tools::ToolRegistryPlanMcpTool;
use thinwedge_tools::ToolRegistryPlanParams;
use thinwedge_tools::ToolUserShellType;
...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    for unavailable_tool in unavailable_called_tools {
        ...
        if existing_spec_names.insert(tool_name.clone()) {
            let spec = thinwedge_tools::ToolSpec::Function(ResponsesApiTool {
