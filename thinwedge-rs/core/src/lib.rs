//! Root of the `thinwedge-core` library.
...
pub use responses_metadata::ThinWedgeResponsesMetadata;
pub use session::SteerInputError;
pub use turn_metadata::detached_memory_responses_metadata;
mod compact_remote;
mod compact_remote_v2;
mod config_lock;
mod thinwedge_thread;
pub use session::turn_context::TurnContext;
pub use thinwedge_thread::BackgroundTerminalInfo;
pub use thinwedge_thread::ThinWedgeThread;
pub use thinwedge_thread::ThinWedgeThreadSettingsOverrides;
pub use thinwedge_thread::ThreadConfigSnapshot;
pub use thinwedge_thread::TryStartTurnIfIdleError;
pub use thinwedge_thread::TryStartTurnIfIdleRejectionReason;
mod agent;
mod attestation;
...
pub use thinwedge_protocol::config_types::ModelProviderAuthInfo;
mod event_mapping;
pub mod review_format;
pub use thinwedge_prompts as review_prompts;
mod thread_manager;
...
#[deprecated(note = "use ThinWedgeThread")]
pub type ThinWedgeConversation = ThinWedgeThread;
...
pub use client::X_THINWEDGE_INSTALLATION_ID_HEADER;
pub use client::X_THINWEDGE_TURN_METADATA_HEADER;
...
pub use thinwedge_prompts::REVIEW_PROMPT;
pub mod compact;
mod memory_usage;
pub mod otel_init;
