...
async fn exec_windows_sandbox(
    ...
    use thinwedge_windows_sandbox::run_windows_sandbox_capture_elevated;
    use thinwedge_windows_sandbox::run_windows_sandbox_capture_with_extra_deny_write_paths;
    ...
    let spawn_res = tokio::task::spawn_blocking(move || {
        if use_elevated {
            run_windows_sandbox_capture_elevated(
                thinwedge_windows_sandbox::ElevatedSandboxCaptureRequest {
