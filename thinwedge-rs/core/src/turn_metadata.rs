...
use thinwedge_git_utils::get_has_changes;
use thinwedge_git_utils::get_head_commit_hash;
...
pub async fn detached_memory_responses_metadata(
    ...
    ThinWedgeResponsesMetadata {
        request_kind: Some(ThinWedgeResponsesRequestKind::Memory),
        subagent_header: subagent_header_value(session_source),
        sandbox: sandbox.map(ToString::to_string),
        workspaces: memory_workspaces(cwd).await,
        ..ThinWedgeResponsesMetadata::new(installation_id, session_id, thread_id, window_id)
    }
}
...
impl TurnMetadataState {
    ...
    pub(crate) fn to_responses_metadata(
        ...
        installation_id: String,
        window_id: String,
        request_kind: ThinWedgeResponsesRequestKind,
    ) -> ThinWedgeResponsesMetadata {
        ThinWedgeResponsesMetadata {
            installation_id,
            window_id,
    ...
    fn responses_metadata_template(&self) -> ThinWedgeResponsesMetadata {
        ThinWedgeResponsesMetadata {
