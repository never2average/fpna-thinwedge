...
fn exec_server_params_use_env_policy_overlay_contract() {
    ...
    let sandbox_policy = thinwedge_protocol::protocol::SandboxPolicy::DangerFullAccess;
    let file_system_sandbox_policy =
        thinwedge_protocol::permissions::FileSystemSandboxPolicy::from(&sandbox_policy);
