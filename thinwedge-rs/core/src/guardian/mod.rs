...
const GUARDIAN_PREFERRED_MODEL: &str = "thinwedge-auto-review";
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: thinwedge_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: thinwedge_protocol::protocol::GuardianUserAuthorization,
