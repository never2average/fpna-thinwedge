...
use thinwedge_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__thinwedge_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__thinwedge_powershell_script__";
