...
use rmcp::model::Meta;
use serde_json::Map;
use thinwedge_mcp::ElicitationReviewRequest;
use thinwedge_mcp::ElicitationReviewer;
use thinwedge_mcp::ElicitationReviewerHandle;
use thinwedge_protocol::config_types::ApprovalsReviewer;
use thinwedge_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as MCP_ELICITATION_APPROVAL_KIND_KEY;
use thinwedge_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as MCP_ELICITATION_APPROVAL_KIND_MCP_TOOL_CALL;
use thinwedge_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as MCP_ELICITATION_APPROVAL_KIND_TOOL_SUGGESTION;
use thinwedge_protocol::mcp_approval_meta::APPROVALS_REVIEWER_KEY as MCP_ELICITATION_APPROVALS_REVIEWER_KEY;
use thinwedge_protocol::mcp_approval_meta::CONNECTOR_DESCRIPTION_KEY as MCP_ELICITATION_CONNECTOR_DESCRIPTION_KEY;
use thinwedge_protocol::mcp_approval_meta::CONNECTOR_ID_KEY as MCP_ELICITATION_CONNECTOR_ID_KEY;
use thinwedge_protocol::mcp_approval_meta::CONNECTOR_NAME_KEY as MCP_ELICITATION_CONNECTOR_NAME_KEY;
use thinwedge_protocol::mcp_approval_meta::REQUEST_TYPE_APPROVAL_REQUEST as MCP_ELICITATION_REQUEST_TYPE_APPROVAL_REQUEST;
use thinwedge_protocol::mcp_approval_meta::REQUEST_TYPE_KEY as MCP_ELICITATION_REQUEST_TYPE_KEY;
use thinwedge_protocol::mcp_approval_meta::TOOL_DESCRIPTION_KEY as MCP_ELICITATION_TOOL_DESCRIPTION_KEY;
use thinwedge_protocol::mcp_approval_meta::TOOL_NAME_KEY as MCP_ELICITATION_TOOL_NAME_KEY;
use thinwedge_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as MCP_ELICITATION_TOOL_PARAMS_KEY;
use thinwedge_protocol::mcp_approval_meta::TOOL_TITLE_KEY as MCP_ELICITATION_TOOL_TITLE_KEY;
...
impl Session {
    ...
    pub(crate) async fn runtime_mcp_servers(
        ...
        thinwedge_mcp::configured_mcp_servers(&self.runtime_mcp_config(config).await)
    }
    ...
    pub async fn request_mcp_server_elicitation(
            ...
            .elicitations_auto_deny()
        {
            return McpServerElicitationOutcome {
                response: Some(ElicitationResponse {
                    action: thinwedge_rmcp_client::ElicitationAction::Accept,
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                thinwedge_protocol::mcp::RequestId::String(value.to_string())
            }
    ...
    async fn refresh_mcp_servers_inner(
        ...
        let tool_plugin_provenance = thinwedge_mcp::tool_plugin_provenance(&mcp_config);
        let mcp_servers =
...
fn plugin_install_elicitation_telemetry_metadata(
    ...
    let thinwedge_protocol::approvals::ElicitationRequest::Form {
