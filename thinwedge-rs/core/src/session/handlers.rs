...
use thinwedge_protocol::protocol::ThreadSettingsAppliedEvent;
use thinwedge_protocol::protocol::ThreadSettingsOverrides;
use thinwedge_protocol::protocol::ThreadSettingsSnapshot;
...
async fn emit_thread_stop_lifecycle(sess: &Session) {
    for contributor in sess.services.extensions.thread_lifecycle_contributors() {
        contributor
            .on_thread_stop(thinwedge_extension_api::ThreadStopInput {
