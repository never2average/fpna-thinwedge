...
pub struct TurnContext {
    ...
    pub(crate) thinwedge_self_exe: Option<PathBuf>,
    pub(crate) thinwedge_linux_sandbox_exe: Option<PathBuf>,
    pub(crate) truncation_policy: TruncationPolicy,
    pub(crate) dynamic_tools: Vec<DynamicToolSpec>,
    pub(crate) turn_metadata_state: Arc<TurnMetadataState>,
    pub(crate) extension_data: Arc<thinwedge_extension_api::ExtensionData>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        let uses_thinwedge_backend = self
            .auth_manager
            .as_deref()
            .is_some_and(AuthManager::current_auth_uses_thinwedge_backend);
        self.features.apps_enabled_for_auth(uses_thinwedge_backend)
    }
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            thinwedge_self_exe: self.thinwedge_self_exe.clone(),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            thinwedge_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(thinwedge_extension_api::ExtensionData::new(sub_id.clone()));
        ...
        TurnContext {
            ...
            thinwedge_self_exe: per_turn_config.thinwedge_self_exe.clone(),
            thinwedge_linux_sandbox_exe: per_turn_config.thinwedge_linux_sandbox_exe.clone(),
    ...
    pub(crate) async fn new_turn_with_sub_id(
    ...
    ) -> ThinWedgeResult<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: ThinWedgeResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                Ok(next) => {
                    ...
                    let thinwedge_home = next.thinwedge_home.clone();
                ...
                Err(err) => Err(ThinWedgeErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (
            ...
            Err(err) => {
                ...
                .await;
                return Err(ThinWedgeErr::InvalidRequest(message));
            }
        };
