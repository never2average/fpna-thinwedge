...
pub(super) async fn spawn_review_thread(
    ...
    let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
        thinwedge_tools::unified_exec_feature_mode_for_features(review_features.get()),
    ...
    let extension_data = Arc::new(thinwedge_extension_api::ExtensionData::new(
        review_turn_id.clone(),
    ));
    ...
    let review_turn_context = TurnContext {
        ...
        thinwedge_self_exe: parent_turn_context.thinwedge_self_exe.clone(),
        thinwedge_linux_sandbox_exe: parent_turn_context.thinwedge_linux_sandbox_exe.clone(),
