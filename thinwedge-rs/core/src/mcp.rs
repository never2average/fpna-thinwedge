...
use thinwedge_mcp::EffectiveMcpServer;
use thinwedge_mcp::McpConfig;
use thinwedge_mcp::McpServerRegistration;
use thinwedge_mcp::THINWEDGE_APPS_MCP_SERVER_NAME;
use thinwedge_mcp::configured_mcp_servers;
use thinwedge_mcp::effective_mcp_servers;
use thinwedge_mcp::thinwedge_apps_mcp_server_config;

const LEGACY_THINWEDGE_APPS_REGISTRATION_ID: &str = "legacy_thinwedge_apps";
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_THINWEDGE_APPS_REGISTRATION_ID,
