...
use thinwedge_config::types::DEFAULT_OTEL_ENVIRONMENT;
...
use thinwedge_config::types::OtelConfig;
...
pub(crate) const DEFAULT_AGENT_MAX_DEPTH: i32 = 3;
    ...
    for deny_read in &filesystem_constraints.deny_read {
        let deny_entry = if deny_read.contains_glob() {
            thinwedge_protocol::permissions::FileSystemSandboxEntry {
                ...
                access: thinwedge_protocol::permissions::FileSystemAccessMode::None,
            }
        } else {
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let user_instructions = AgentsMdManager::load_global_instructions(Some(&thinwedge_home))
        ...
        let helper_readable_roots = get_readable_roots_required_for_thinwedge_runtime(
            &thinwedge_home,
            zsh_path.as_ref(),
        ...
        let config = Self {
            ...
            chatgpt_base_url: config_profile
                ...
                .unwrap_or("https://example.invalid/backend-api/".to_string()),
            realtime_audio: cfg
                .audio
