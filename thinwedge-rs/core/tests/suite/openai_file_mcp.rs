...
const DOCUMENT_EXTRACT_NAMESPACE: &str = "mcp__thinwedge_apps__calendar";
const DOCUMENT_EXTRACT_TOOL: &str = "_extract_text";
const DOCUMENT_EXTRACT_HOOK_MATCHER: &str = "mcp__thinwedge_apps__calendar_extract_text";
...
async fn thinwedge_apps_file_params_upload_local_paths_before_mcp_tool_call() -> Result<()> {
