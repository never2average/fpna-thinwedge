...
async fn responses_mode_stream_cli() {
    ...
    //     10,
    //     None,
    //     thinwedge_core::ThreadSortKey::UpdatedAt,
    //     &[],
...
/// Verify that `thinwedge exec --profile ...` preserves the active profile when it
...
/// 2. Configures thinwedge to read from this fixture via THINWEDGE_RS_SSE_FIXTURE env var
