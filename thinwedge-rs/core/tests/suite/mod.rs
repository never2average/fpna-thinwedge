...
#[ctor]
pub static THINWEDGE_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("thinwedge-core-tests", |exe_name, argv1| {
        if argv1 == Some(THINWEDGE_CORE_APPLY_PATCH_ARG1) {
