...
use core_test_support::test_thinwedge::ShellModelOutput;
...
fn configure_shell_model(
    builder: TestThinWedgeBuilder,
    output_type: ShellModelOutput,
    include_apply_patch_tool: bool,
) -> TestThinWedgeBuilder {
    let builder = match (output_type, include_apply_patch_tool) {
        (ShellModelOutput::ShellCommand, _) => builder.with_model("test-gpt-5-thinwedge"),
