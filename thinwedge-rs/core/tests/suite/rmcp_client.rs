...
fn auto_approved_user_turn(fixture: &TestThinWedge, text: impl Into<String>) -> Op {
...
fn remote_aware_environment_id() -> String {
    ...
    std::env::var_os(remote_env_env_var())
        ...
        .unwrap_or_else(|| thinwedge_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
}
...
async fn stdio_server_round_trip() -> anyhow::Result<()> {
    ...
    let fixture = test_thinwedge()
        ...
        .await?;
    wait_for_mcp_server(&fixture.thinwedge, server_name).await?;
...
async fn shutdown_cancels_startup_prewarm_waiting_for_mcp_startup() -> anyhow::Result<()> {
    ...
    tokio::time::timeout(
        ...
        fixture.thinwedge.shutdown_and_wait(),
    )
    .await
        ...
        ModelsResponse {
            models: vec![ModelInfo {
                ...
                supported_reasoning_levels: vec![ReasoningEffortPreset {
                    effort: thinwedge_protocol::openai_models::ReasoningEffort::Medium,
