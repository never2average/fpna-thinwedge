use crate::test_thinwedge::TestThinWedgeBuilder;
use crate::test_thinwedge::test_thinwedge;
use anyhow::Result;
...
const THINWEDGE_APPS_META_KEY: &str = "_thinwedge_apps";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "thinwedge-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__thinwedge_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__thinwedge_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__thinwedge_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__thinwedge_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__thinwedge_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestThinWedgeBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestThinWedgeBuilder {
    let apps_base_url = apps_base_url.into();
    test_thinwedge()
        .with_auth(ThinWedgeAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/thinwedge/apps/?$"))
        .respond_with(ThinWedgeAppsJsonRpcResponder {
            connector_name,
...
struct ThinWedgeAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for ThinWedgeAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let thinwedge_apps_meta = body.pointer("/params/_meta/_thinwedge_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_thinwedge_apps": thinwedge_apps_meta,
                        },
                        "isError": false
                    }
                }))
