...
pub enum Feature {
    ...
    /// Prompt ThinWedge Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: ThinWedge can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart ThinWedge after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
