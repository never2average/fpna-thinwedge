...
impl RealtimeWebsocketClient {
    ...
    async fn connect_realtime_websocket_url(
        ...
        // Realtime websocket TLS should honor the same custom-CA env vars as the rest of ThinWedge's
...
mod tests {
    ...
    use thinwedge_protocol::protocol::RealtimeInputAudioSpeechStarted;
