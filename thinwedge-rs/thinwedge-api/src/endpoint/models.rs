...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut thinwedge_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let client = ModelsClient::new(
            transport.clone(),
            provider("https://example.com/api/thinwedge"),
            Arc::new(DummyAuth),
        );
        ...
        assert_eq!(
            url,
            "https://example.com/api/thinwedge/models?client_version=0.99.0"
        );
    }
