...
use super::ThinWedgeHomeUserInstructionsProvider;

fn provider(home: &TempDir) -> ThinWedgeHomeUserInstructionsProvider {
    ThinWedgeHomeUserInstructionsProvider::new(
