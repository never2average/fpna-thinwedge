...
use thinwedge_api::ImageBackground;
use thinwedge_api::ImageEditRequest;
use thinwedge_api::ImageGenerationRequest;
use thinwedge_api::ImageQuality;
use thinwedge_api::ImageUrl;
use thinwedge_core::context::extension_image_generation_output_hint;
use thinwedge_core::image_generation_artifact_path;
use thinwedge_extension_api::ExtensionTurnItem;
use thinwedge_extension_api::FunctionCallError;
use thinwedge_extension_api::ToolCall;
use thinwedge_extension_api::ToolEnvironment;
...
use thinwedge_extension_api::parse_tool_input_schema;
...
pub(crate) struct ImageGenerationTool {
    backend: ThinWedgeImagesBackend,
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> thinwedge_extension_api::ToolExecutorFuture<'_> {
...
impl ImageGenerationTool {
    async fn handle_call(&self, call: ToolCall) -> Result<Box<dyn ToolOutput>, FunctionCallError> {
        ...
        call.turn_item_emitter
            ...
            .await;
        let output_path =
            image_generation_artifact_path(&self.thinwedge_home, &self.thread_id, &call.call_id);
        let output_dir = output_path
            .parent()
            .unwrap_or_else(|| self.thinwedge_home.clone());
        let output_hint =
