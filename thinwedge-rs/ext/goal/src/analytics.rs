...
use thinwedge_analytics::GoalEventKind;
use thinwedge_analytics::ThinWedgeGoalEvent;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &thinwedge_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(ThinWedgeGoalEvent {
