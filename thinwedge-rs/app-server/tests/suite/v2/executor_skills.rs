...
use thinwedge_app_server_protocol::CapabilityRootLocation;
...
"#,
    ...
    let local_skill_dir = thinwedge_home.path().join("skills/local-deploy");
    ...
    let manifest_dir = plugin_dir.path().join(".thinwedge-plugin");
