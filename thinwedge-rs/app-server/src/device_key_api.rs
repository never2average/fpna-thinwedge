...
use thinwedge_app_server_protocol::DeviceKeyProtectionClass;
use thinwedge_app_server_protocol::DeviceKeyPublicParams;
use thinwedge_app_server_protocol::DeviceKeyPublicResponse;
use thinwedge_app_server_protocol::DeviceKeySignParams;
use thinwedge_app_server_protocol::DeviceKeySignPayload;
use thinwedge_app_server_protocol::DeviceKeySignResponse;
use thinwedge_app_server_protocol::JSONRPCErrorError;
use thinwedge_device_key::DeviceKeyBinding;
use thinwedge_device_key::DeviceKeyBindingStore;
use thinwedge_device_key::DeviceKeyCreateRequest;
use thinwedge_device_key::DeviceKeyError;
use thinwedge_device_key::DeviceKeyGetPublicRequest;
use thinwedge_device_key::DeviceKeyInfo;
use thinwedge_device_key::DeviceKeyProtectionPolicy;
use thinwedge_device_key::DeviceKeySignRequest;
use thinwedge_device_key::DeviceKeyStore;
use thinwedge_device_key::RemoteControlClientConnectionAudience;
use thinwedge_device_key::RemoteControlClientConnectionSignPayload;
use thinwedge_device_key::RemoteControlClientEnrollmentAudience;
...
fn protection_policy_from_params(
    protection_policy: Option<thinwedge_app_server_protocol::DeviceKeyProtectionPolicy>,
) -> DeviceKeyProtectionPolicy {
    match protection_policy
        .unwrap_or(thinwedge_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly)
    {
        thinwedge_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly => {
            DeviceKeyProtectionPolicy::HardwareOnly
        }
        thinwedge_app_server_protocol::DeviceKeyProtectionPolicy::AllowOsProtectedNonextractable => {
...
fn payload_from_params(
    ...
    match payload {
        DeviceKeySignPayload::RemoteControlClientConnection {
            ...
            token_expires_at,
            scopes,
        } => thinwedge_device_key::DeviceKeySignPayload::RemoteControlClientConnection(
        ...
        } => thinwedge_device_key::DeviceKeySignPayload::RemoteControlClientEnrollment(
...
fn remote_control_client_connection_audience_from_protocol(
    audience: thinwedge_app_server_protocol::RemoteControlClientConnectionAudience,
) -> RemoteControlClientConnectionAudience {
    match audience {
        thinwedge_app_server_protocol::RemoteControlClientConnectionAudience::RemoteControlClientWebsocket => {
...
fn remote_control_client_enrollment_audience_from_protocol(
    audience: thinwedge_app_server_protocol::RemoteControlClientEnrollmentAudience,
) -> RemoteControlClientEnrollmentAudience {
    match audience {
        thinwedge_app_server_protocol::RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment => {
            RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment
        }
    }
}

fn algorithm_from_store(algorithm: thinwedge_device_key::DeviceKeyAlgorithm) -> DeviceKeyAlgorithm {
    match algorithm {
        thinwedge_device_key::DeviceKeyAlgorithm::EcdsaP256Sha256 => {
...
fn protection_class_from_store(
    protection_class: thinwedge_device_key::DeviceKeyProtectionClass,
) -> DeviceKeyProtectionClass {
    match protection_class {
        thinwedge_device_key::DeviceKeyProtectionClass::HardwareSecureEnclave => {
            DeviceKeyProtectionClass::HardwareSecureEnclave
        }
        thinwedge_device_key::DeviceKeyProtectionClass::HardwareTpm => {
            DeviceKeyProtectionClass::HardwareTpm
        }
        thinwedge_device_key::DeviceKeyProtectionClass::OsProtectedNonextractable => {
