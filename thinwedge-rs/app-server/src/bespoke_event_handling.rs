...
use thinwedge_app_server_protocol::ThreadSettingsUpdatedNotification;
...
use thinwedge_app_server_protocol::TurnModerationMetadataNotification;
...
use thinwedge_app_server_protocol::item_event_to_server_notification;
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: thinwedge_thread_store::StoredThread,
    session_id: String,
...
mod tests {
    ...
    use thinwedge_thread_store::StoredThreadHistory;
    use thinwedge_utils_absolute_path::AbsolutePathBuf;
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(thinwedge_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(thinwedge_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    ...
                    kind: thinwedge_app_server_protocol::SubAgentActivityKind::Interrupted,
