...
use thinwedge_app_server_protocol::CommandAction as V2ParsedCommand;
...
use thinwedge_app_server_protocol::ContextCompactedNotification;
use thinwedge_app_server_protocol::DeprecationNoticeNotification;
...
use thinwedge_app_server_protocol::ExecCommandApprovalParams;
use thinwedge_app_server_protocol::ExecCommandApprovalResponse;
use thinwedge_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use thinwedge_app_server_protocol::FileChangeApprovalDecision;
use thinwedge_app_server_protocol::FileChangeOutputDeltaNotification;
use thinwedge_app_server_protocol::FileChangePatchUpdatedNotification;
use thinwedge_app_server_protocol::FileChangeRequestApprovalParams;
use thinwedge_app_server_protocol::FileChangeRequestApprovalResponse;
use thinwedge_app_server_protocol::FileUpdateChange;
use thinwedge_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use thinwedge_app_server_protocol::GuardianWarningNotification;
use thinwedge_app_server_protocol::HookCompletedNotification;
use thinwedge_app_server_protocol::HookStartedNotification;
use thinwedge_app_server_protocol::InterruptConversationResponse;
...
use thinwedge_app_server_protocol::McpToolCallError;
use thinwedge_app_server_protocol::McpToolCallResult;
use thinwedge_app_server_protocol::McpToolCallStatus;
use thinwedge_app_server_protocol::ModelReroutedNotification;
use thinwedge_app_server_protocol::ModelVerificationNotification;
use thinwedge_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use thinwedge_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use thinwedge_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use thinwedge_app_server_protocol::PatchApplyStatus;
use thinwedge_app_server_protocol::PermissionsRequestApprovalParams;
use thinwedge_app_server_protocol::PermissionsRequestApprovalResponse;
use thinwedge_app_server_protocol::PlanDeltaNotification;
use thinwedge_app_server_protocol::RawResponseItemCompletedNotification;
use thinwedge_app_server_protocol::ReasoningSummaryPartAddedNotification;
use thinwedge_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use thinwedge_app_server_protocol::ReasoningTextDeltaNotification;
...
use thinwedge_app_server_protocol::ThreadRealtimeClosedNotification;
use thinwedge_app_server_protocol::ThreadRealtimeErrorNotification;
use thinwedge_app_server_protocol::ThreadRealtimeItemAddedNotification;
use thinwedge_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use thinwedge_app_server_protocol::ThreadRealtimeSdpNotification;
use thinwedge_app_server_protocol::ThreadRealtimeStartedNotification;
use thinwedge_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use thinwedge_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use thinwedge_app_server_protocol::ThreadRollbackResponse;
use thinwedge_app_server_protocol::ThreadTokenUsage;
use thinwedge_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use thinwedge_app_server_protocol::ToolRequestUserInputOption;
...
use thinwedge_app_server_protocol::TurnPlanStep;
use thinwedge_app_server_protocol::TurnPlanUpdatedNotification;
use thinwedge_app_server_protocol::TurnStartedNotification;
use thinwedge_app_server_protocol::TurnStatus;
use thinwedge_app_server_protocol::WarningNotification;
use thinwedge_app_server_protocol::build_command_execution_end_item;
use thinwedge_app_server_protocol::build_file_change_approval_request_item;
use thinwedge_app_server_protocol::build_file_change_begin_item;
use thinwedge_app_server_protocol::build_file_change_end_item;
use thinwedge_app_server_protocol::build_item_from_guardian_event;
use thinwedge_app_server_protocol::build_turns_from_rollout_items;
use thinwedge_app_server_protocol::convert_patch_changes;
use thinwedge_app_server_protocol::guardian_auto_approval_review_notification;
use thinwedge_core::ThinWedgeThread;
use thinwedge_core::ThreadManager;
use thinwedge_core::find_thread_name_by_id;
use thinwedge_core::review_format::format_review_findings_block;
use thinwedge_core::review_prompts;
...
use thinwedge_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use thinwedge_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    thinwedge_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    thinwedge_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    thinwedge_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    thinwedge_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            if let ApiVersion::V2 = api_version {
                ...
                if assessment.status
                    == thinwedge_protocol::protocol::GuardianAssessmentStatus::InProgress
                ...
                let completion_status = match assessment.status {
                    thinwedge_protocol::protocol::GuardianAssessmentStatus::Denied
                    | thinwedge_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                        Some(CommandExecutionStatus::Declined)
                    }
                    thinwedge_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                        Some(CommandExecutionStatus::Failed)
                    }
                    thinwedge_protocol::protocol::GuardianAssessmentStatus::InProgress
                    | thinwedge_protocol::protocol::GuardianAssessmentStatus::Approved => None,
                };
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: thinwedge_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::Error(ev) => {
            ...
            let thinwedge_error_info = ev.thinwedge_error_info.clone();
            ...
            if matches!(
                ...
                Some(CoreThinWedgeErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                thinwedge_error_info: ev.thinwedge_error_info.map(V2ThinWedgeErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(api_version, ApiVersion::V2)
                && matches!(
                    ...
                    thinwedge_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
                )
            {
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: thinwedge_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let thinwedge_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(thinwedge_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
async fn respond_to_pending_interrupts(
    thread_state: &Arc<Mutex<ThreadState>>,
    outgoing: &ThreadScopedOutgoingMessageSender,
    abort_reason: Option<thinwedge_protocol::protocol::TurnAbortReason>,
) {
    let pending = {
        let mut state = thread_state.lock().await;
...
async fn on_patch_approval_response(
    ...
    let value = match response {
        ...
        Ok(Err(err)) => {
            ...
            if let Err(submit_err) = thinwedge
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `thinwedge`.
    let response =
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: thinwedge_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            thinwedge_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
fn collab_resume_begin_item(
    begin_event: thinwedge_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
mod tests {
    ...
    use thinwedge_protocol::items::build_hook_prompt_message;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: thinwedge_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(thinwedge_protocol::protocol::GuardianRiskLevel::Low),
                Some(thinwedge_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(thinwedge_protocol::protocol::GuardianRiskLevel::High),
                Some(thinwedge_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(thinwedge_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = thinwedge_protocol::protocol::GuardianAssessmentAction::Command {
            source: thinwedge_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                turn_id: String::new(),
                status: thinwedge_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(thinwedge_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(thinwedge_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                target_item_id: None,
                turn_id: "turn-from-assessment".to_string(),
                status: thinwedge_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&thinwedge_home).await;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: thinwedge_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(thinwedge_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                thinwedge_error_info: Some(V2ThinWedgeErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                thinwedge_error_info: Some(V2ThinWedgeErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("thinwedge"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                thinwedge_error_info: Some(V2ThinWedgeErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            thinwedge_app_server_protocol::HookPromptFragment {
