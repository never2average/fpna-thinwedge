...
use thinwedge_app_server_protocol::ComputerUseRequirements;
...
impl ConfigRequestProcessor {
    ...
    ) -> Result<thinwedge_core::config::Config, JSONRPCErrorError> {
        self.config_manager
    ...
    async fn write_value(
        ...
        let pending_changes = thinwedge_core_plugins::toggles::collect_plugin_enabled_candidates(
    ...
    async fn emit_plugin_toggle_events(
        ...
        for (plugin_id, enabled) in pending_changes {
            ...
            let metadata = thinwedge_core_plugins::loader::installed_plugin_telemetry_metadata(
                ...
                .map(|implementations| {
                    implementations
                        ...
                        .map(|implementation| match implementation {
                            thinwedge_config::types::WindowsSandboxModeToml::Elevated => {
                                WindowsSandboxSetupMode::Elevated
                            }
                            thinwedge_config::types::WindowsSandboxModeToml::Unelevated => {
...
fn map_computer_use_requirements_to_api(
    computer_use: thinwedge_config::ComputerUseRequirementsToml,
...
fn map_network_unix_socket_permission_to_api(
    ...
    match permission {
        ...
        thinwedge_config::NetworkUnixSocketPermissionToml::Deny => {
...
mod tests {
    ...
    use thinwedge_app_server_protocol::WindowsSandboxSetupMode;
    use thinwedge_config::ComputerUseRequirementsToml;
    use thinwedge_config::ConfigRequirementsToml;
    use thinwedge_config::WindowsRequirementsToml;
