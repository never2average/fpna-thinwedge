...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, thinwedge_apps_ready)| !thinwedge_apps_ready);
        outgoing
        ...
        if should_retry && !retry_params.force_refetch {
            ...
            .await
            {
                warn!("failed to refresh app list after thinwedge-apps readiness retry: {err:?}");
            }
        }
    }
    ...
    async fn apps_list_response(
        ...
        let mut thinwedge_apps_ready = true;
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    thinwedge_apps_ready = status.thinwedge_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, thinwedge_apps_ready));
            }
        }
    }
