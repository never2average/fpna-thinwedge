...
) -> Option<thinwedge_app_server_protocol::ActivePermissionProfile> {
...
pub(crate) fn thread_settings_from_core_snapshot(
    snapshot: thinwedge_protocol::protocol::ThreadSettingsSnapshot,
) -> ThreadSettings {
    let thinwedge_protocol::protocol::ThreadSettingsSnapshot {
        model,
        model_provider_id,
        service_tier,
        approval_policy,
