...
pub(crate) use thinwedge_app_server_transport::OutgoingError;
pub(crate) use thinwedge_app_server_transport::OutgoingMessage;
pub(crate) use thinwedge_app_server_transport::OutgoingResponse;
...
mod tests {
    ...
    use thinwedge_app_server_protocol::ModelRerouteReason;
    use thinwedge_app_server_protocol::ModelReroutedNotification;
    use thinwedge_app_server_protocol::ModelVerification;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-thinwedge".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, thinwedge_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    thinwedge_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
