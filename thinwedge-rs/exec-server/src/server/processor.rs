    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                thinwedge_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                thinwedge_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                thinwedge_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                thinwedge_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
