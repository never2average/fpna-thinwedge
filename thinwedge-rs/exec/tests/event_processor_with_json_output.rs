...
use thinwedge_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use thinwedge_app_server_protocol::CommandAction;
use thinwedge_app_server_protocol::CommandExecutionSource;
use thinwedge_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use thinwedge_app_server_protocol::ErrorNotification;
use thinwedge_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use thinwedge_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use thinwedge_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use thinwedge_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use thinwedge_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use thinwedge_exec::CollabToolCallItem;
use thinwedge_exec::CollabToolCallStatus;
use thinwedge_exec::CollectedThreadEvents;
use thinwedge_exec::CommandExecutionItem;
use thinwedge_exec::CommandExecutionStatus;
use thinwedge_exec::ErrorItem;
use thinwedge_exec::EventProcessorWithJsonOutput;
use thinwedge_exec::ExecThreadItem;
use thinwedge_exec::FileChangeItem;
use thinwedge_exec::FileUpdateChange as ExecFileUpdateChange;
use thinwedge_exec::ItemCompletedEvent;
use thinwedge_exec::ItemStartedEvent;
use thinwedge_exec::ItemUpdatedEvent;
use thinwedge_exec::McpToolCallItem;
use thinwedge_exec::McpToolCallItemError;
use thinwedge_exec::McpToolCallItemResult;
use thinwedge_exec::McpToolCallStatus;
...
use thinwedge_exec::ThreadStartedEvent;
use thinwedge_exec::TodoItem;
use thinwedge_exec::TodoListItem;
use thinwedge_exec::TurnCompletedEvent;
use thinwedge_exec::TurnFailedEvent;
use thinwedge_exec::TurnStartedEvent;
use thinwedge_exec::Usage;
use thinwedge_exec::WebSearchItem;
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: ThinWedgeStatus::InitiateShutdown,
        }
    );
}
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, ThinWedgeStatus::Running);
    ...
    assert_eq!(collected.status, ThinWedgeStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        thinwedge_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: thinwedge_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
