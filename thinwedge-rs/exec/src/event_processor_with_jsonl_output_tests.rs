...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        thinwedge_app_server_protocol::TurnCompletedNotification {
            ...
            turn: thinwedge_app_server_protocol::Turn {
                ...
                error: Some(thinwedge_app_server_protocol::TurnError {
    ...
    assert_eq!(status, ThinWedgeStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        thinwedge_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI ThinWedge CLI documentation"}]}),
                mcp_app_resource_uri: None,
                plugin_id: None,
                result: Some(Box::new(thinwedge_app_server_protocol::McpToolCallResult {
