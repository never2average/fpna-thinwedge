use crate::default_client::ThinWedgeHttpClient;
use crate::default_client::ThinWedgeRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: ThinWedgeHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<ThinWedgeRequestBuilder, TransportError> {
