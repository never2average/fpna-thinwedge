...
const SESSION_NAME: &str = "ThinWedge Windows Sandbox WFP";
const PROVIDER_NAME: &str = "ThinWedge Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for ThinWedge Windows sandbox filters";
const SUBLAYER_NAME: &str = "ThinWedge Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for ThinWedge Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are ThinWedge-owned identities; do not regenerate them unless we
...
/// Installs the persistent ThinWedge WFP filters for `account`.
///
...
/// Ensures the persistent ThinWedge WFP provider exists.
...
/// Ensures the persistent ThinWedge sublayer exists under the ThinWedge provider.
