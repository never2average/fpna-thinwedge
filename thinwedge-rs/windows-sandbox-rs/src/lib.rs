...
#[cfg(target_os = "windows")]
pub use logging::current_log_file_path_for_thinwedge_home;
#[cfg(target_os = "windows")]
...
mod windows_impl {
    ...
    use super::sandbox_utils::ensure_thinwedge_home_exists;
    ...
    pub fn run_windows_sandbox_capture_with_filesystem_overrides(
        ...
        let capability_roots =
            legacy_session_capability_roots(&permissions, &current_dir, &env_map, thinwedge_home);
