...
use thinwedge_windows_sandbox::ErrorPayload;
use thinwedge_windows_sandbox::ExitPayload;
use thinwedge_windows_sandbox::FramedMessage;
use thinwedge_windows_sandbox::IPC_PROTOCOL_VERSION;
use thinwedge_windows_sandbox::LocalSid;
use thinwedge_windows_sandbox::Message;
use thinwedge_windows_sandbox::OutputPayload;
use thinwedge_windows_sandbox::OutputStream;
use thinwedge_windows_sandbox::PipeSpawnHandles;
use thinwedge_windows_sandbox::ResizePayload;
use thinwedge_windows_sandbox::SpawnReady;
use thinwedge_windows_sandbox::SpawnRequest;
use thinwedge_windows_sandbox::StderrMode;
use thinwedge_windows_sandbox::StdinMode;
use thinwedge_windows_sandbox::WindowsSandboxTokenMode;
use thinwedge_windows_sandbox::allow_null_device;
use thinwedge_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use thinwedge_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use thinwedge_windows_sandbox::decode_bytes;
use thinwedge_windows_sandbox::encode_bytes;
use thinwedge_windows_sandbox::get_current_token_for_restriction;
use thinwedge_windows_sandbox::hide_current_user_profile_dir;
use thinwedge_windows_sandbox::log_note;
use thinwedge_windows_sandbox::read_frame;
use thinwedge_windows_sandbox::read_handle_loop;
use thinwedge_windows_sandbox::spawn_process_with_pipes;
use thinwedge_windows_sandbox::to_wide;
use thinwedge_windows_sandbox::token_mode_for_permission_profile;
use thinwedge_windows_sandbox::write_frame;
...
const READ_ACL_MUTEX_NAME: &str = "Local\\ThinWedgeSandboxReadAcl";
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<thinwedge_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    let log_dir = req.thinwedge_home.clone();
    hide_current_user_profile_dir(req.thinwedge_home.as_path());
    ...
    let (pi, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = thinwedge_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
