...
const SETUP_BIN: &str = "thinwedge-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "thinwedge-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so ThinWedge binaries that link the
