...
```
export THINWEDGE_HOME="${THINWEDGE_HOME:-$HOME/.thinwedge}"
export IMAGE_GEN="$THINWEDGE_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
...
- Network/sandbox notes for fallback CLI mode: `references/thinwedge-network.md`
- Built-in-first transparent image workflow: `SKILL.md` and `$THINWEDGE_HOME/skills/.system/imagegen/scripts/remove_chroma_key.py`
