...
After installing a skill, tell the user: "Restart ThinWedge to pick up new skills."
...
- Installs into `$THINWEDGE_HOME/skills/<skill-name>` (defaults to `~/.thinwedge/skills`).
