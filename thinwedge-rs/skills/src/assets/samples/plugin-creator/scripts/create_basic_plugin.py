...
def build_plugin_json(plugin_name: str) -> dict:
    return {
        ...
        "interface": {
            ...
            "developerName": "[TODO: ThinWedge]",
            "category": "[TODO: Productivity]",
            "capabilities": ["[TODO: Interactive]", "[TODO: Write]"],
            "websiteURL": "[TODO: https://thinwedge.com/]",
            "privacyPolicyURL": "[TODO: https://thinwedge.com/policies/row-privacy-policy/]",
            "termsOfServiceURL": "[TODO: https://thinwedge.com/policies/row-terms-of-use/]",
            "defaultPrompt": [
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".thinwedge-plugin" / "plugin.json"
