...
/// Runtime operation requested by the model, a JS code cell, or ThinWedge itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_thinwedge_turn_id: Option<ThinWedgeTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the ThinWedge tool boundary.
    ///
    ...
    /// they describe how ThinWedge executed the request, not what the caller sent.
