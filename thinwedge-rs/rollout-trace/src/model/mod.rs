...
/// ThinWedge conversation/session UUID.
...
pub type ThinWedgeTurnId = String;
...
/// Process/session ID returned by ThinWedge's terminal runtime.
...
/// Canonical reduced graph for one ThinWedge rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the ThinWedge rollout/session being observed. `trace_id`
    ...
    pub thinwedge_turns: BTreeMap<ThinWedgeTurnId, ThinWedgeTurn>,
