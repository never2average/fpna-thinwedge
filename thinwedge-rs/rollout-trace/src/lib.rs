//! Trace bundle format, writer, and reducer for ThinWedge rollouts.
//!
//! This crate owns the trace schema. Hot-path ThinWedge code should depend on the
...
/// Shared recorder context for inference attempts within one ThinWedge turn.
...
pub use thread::THINWEDGE_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical ThinWedge tool boundary.
...
/// Append-only writer used by hot-path ThinWedge instrumentation.
