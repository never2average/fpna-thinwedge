...
pub struct RawTraceEvent {
    ...
    pub thinwedge_turn_id: Option<ThinWedgeTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before ThinWedge stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why ThinWedge stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how ThinWedge began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how ThinWedge finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_thinwedge_turn_id: ThinWedgeTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::ThinWedgeTurnEnded { .. }
