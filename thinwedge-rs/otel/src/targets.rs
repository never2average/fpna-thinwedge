pub(crate) const OTEL_TARGET_PREFIX: &str = "thinwedge_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "thinwedge_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "thinwedge_otel.trace_safe";
