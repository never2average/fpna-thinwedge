...
impl SessionTelemetry {
    ...
    pub fn record_startup_phase(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.startup_phase",
                startup.phase = phase,
    ...
    pub fn record_turn_ttft(&self, duration: Duration) {
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.turn_ttft",
                duration_ms = %duration.as_millis(),
            },
            log: {},
            trace: {},
    ...
    pub fn record_plugin_install_elicitation_sent(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.plugin_install_elicitation_sent",
    ...
    pub fn record_plugin_install_suggestion(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.plugin_install_suggestion",
                plugin_install.tool_type = tool_type,
                plugin_install.tool_id = tool_id,
                plugin_install.tool_name = tool_name,
    ...
    pub fn record_api_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.api_request",
                duration_ms = %duration.as_millis(),
    ...
    pub fn record_websocket_connect(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.websocket_connect",
                duration_ms = %duration.as_millis(),
                http.response.status_code = status,
                success = success_str,
                error.message = error,
    ...
    pub fn record_websocket_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.websocket_request",
                duration_ms = %duration.as_millis(),
                success = success_str,
                error.message = error,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
    ...
    pub fn record_auth_recovery(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.auth_recovery",
                auth.mode = mode,
                auth.step = step,
    ...
    pub fn record_websocket_event(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "thinwedge.websocket_event",
                event.kind = %kind_str,
                duration_ms = %duration.as_millis(),
                success = success_str,
    ...
    fn sse_event(&self, kind: &str, duration: Duration) {
        ...
        log_event!(
            self,
            event.name = "thinwedge.sse_event",
            event.kind = %kind,
            duration_ms = %duration.as_millis(),
        );
    }
    ...
    pub fn user_prompt(&self, items: &[UserInput]) {
        ...
        log_event!(
            self,
            event.name = "thinwedge.user_prompt",
    ...
    pub fn tool_decision(
        ...
        log_event!(
            self,
            event.name = "thinwedge.tool_decision",
            tool_name = %tool_name,
            call_id = %call_id,
    ...
    pub fn sandbox_outcome(
        ...
        log_event!(
            self,
            event.name = "thinwedge.sandbox_outcome",
            tool_name = %tool_name,
            call_id = %call_id,
            outcome = %outcome,
    ...
    pub fn log_tool_failed(&self, tool_name: &str, error: &str) {
        log_event!(
            self,
            event.name = "thinwedge.tool_result",
            tool_name = %tool_name,
