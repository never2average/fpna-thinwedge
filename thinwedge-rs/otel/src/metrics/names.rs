...
pub const SSE_EVENT_DURATION_METRIC: &str = "thinwedge.sse_event.duration_ms";
pub const WEBSOCKET_REQUEST_COUNT_METRIC: &str = "thinwedge.websocket.request";
...
pub const RESPONSES_API_ENGINE_IAPI_TTFT_DURATION_METRIC: &str =
    "thinwedge.responses_api_engine_iapi_ttft.duration_ms";
pub const RESPONSES_API_ENGINE_SERVICE_TTFT_DURATION_METRIC: &str =
    "thinwedge.responses_api_engine_service_ttft.duration_ms";
pub const RESPONSES_API_ENGINE_IAPI_TBT_DURATION_METRIC: &str =
    "thinwedge.responses_api_engine_iapi_tbt.duration_ms";
pub const RESPONSES_API_ENGINE_SERVICE_TBT_DURATION_METRIC: &str =
    "thinwedge.responses_api_engine_service_tbt.duration_ms";
pub const TURN_E2E_DURATION_METRIC: &str = "thinwedge.turn.e2e_duration_ms";
pub const TURN_TTFT_DURATION_METRIC: &str = "thinwedge.turn.ttft.duration_ms";
pub const TURN_TTFM_DURATION_METRIC: &str = "thinwedge.turn.ttfm.duration_ms";
pub const TURN_NETWORK_PROXY_METRIC: &str = "thinwedge.turn.network_proxy";
...
pub const STARTUP_PREWARM_AGE_AT_FIRST_TURN_METRIC: &str =
    "thinwedge.startup_prewarm.age_at_first_turn_ms";
pub const THREAD_STARTED_METRIC: &str = "thinwedge.thread.started";
pub const THREAD_SKILLS_ENABLED_TOTAL_METRIC: &str = "thinwedge.thread.skills.enabled_total";
pub const THREAD_SKILLS_KEPT_TOTAL_METRIC: &str = "thinwedge.thread.skills.kept_total";
pub const THREAD_SKILLS_DESCRIPTION_TRUNCATED_CHARS_METRIC: &str =
    "thinwedge.thread.skills.description_truncated_chars";
pub const THREAD_SKILLS_TRUNCATED_METRIC: &str = "thinwedge.thread.skills.truncated";
