...
impl AppServerClient {
    pub fn spawn(
        ...
        let mut child = cmd
            ...
            .spawn()
            .with_context(|| format!("failed to start `{thinwedge_bin}` app-server"))?;
    ...
    pub fn initialize(&mut self) -> Result<()> {
        ...
        let request = ClientRequest::Initialize {
            ...
            params: thinwedge_app_server_protocol::InitializeParams {
        ...
        let _parsed: thinwedge_app_server_protocol::InitializeResponse =
...
fn handle_server_request(
    ...
    let Ok(server_request) = thinwedge_app_server_protocol::ServerRequest::try_from(request) else {
        return Ok(());
    };

    match server_request {
        thinwedge_app_server_protocol::ServerRequest::CommandExecutionRequestApproval {
            request_id,
            ..
        } => {
            let response = thinwedge_app_server_protocol::CommandExecutionRequestApprovalResponse {
