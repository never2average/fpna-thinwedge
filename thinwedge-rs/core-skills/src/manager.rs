...
use thinwedge_config::SkillsConfig;
...
impl SkillsManager {
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.thinwedge_home);
        } else if let Err(err) = install_system_skills(&manager.thinwedge_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &thinwedge_config::ConfigLayerStack,
) -> bool {
