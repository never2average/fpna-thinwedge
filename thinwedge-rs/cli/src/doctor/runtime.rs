//! Captures how this ThinWedge process was launched.
//!
...
/// Builds the process provenance row for the current ThinWedge executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled ThinWedge package.");
    }
    check
}
...
fn build_commit() -> &'static str {
    option_env!("THINWEDGE_BUILD_COMMIT")
