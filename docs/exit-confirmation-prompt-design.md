...
This document describes how exit, shutdown, and interruption work in the Rust TUI (`thinwedge-rs/tui`).
It is intended for ThinWedge developers and ThinWedge itself when reasoning about future exit/shutdown
changes.
...
ThinWedge has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
