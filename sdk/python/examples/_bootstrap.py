...
def ensure_local_sdk_src() -> Path:
    ...
    package_dir = src_dir / "openai_thinwedge"
...
def runtime_config():
    """Return an example-friendly ThinWedgeConfig for repo-source SDK usage."""
...
def temporary_sample_image_path() -> Iterator[Path]:
    with tempfile.TemporaryDirectory(prefix="thinwedge-python-example-image-") as temp_root:
