...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any,
        Field(
            description="Serialized `thinwedge_protocol::protocol::GuardianAssessmentEvent`."
        ),
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class TurnError(BaseModel):
    ...
    thinwedge_error_info: Annotated[
        ThinWedgeErrorInfo | None, Field(alias="thinwedgeErrorInfo")
    ] = None
    message: str
