...
#   filename:  thinwedge_app_server_protocol.v2.schemas.json
...
class ThinWedgeAppServerProtocolV2(BaseModel):
    pass
...
class ThinWedgeErrorInfoValue(Enum):
...
class HttpConnectionFailedThinWedgeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedThinWedgeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedThinWedgeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsThinWedgeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_thinwedge_folder: Annotated[AbsolutePathBuf, Field(alias="dotThinWedgeFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.thinwedge, etc.).",
        ),
    ] = None
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    thinwedge_streamlined_login: Annotated[bool | None, Field(alias="thinwedgeStreamlinedLogin")] = None
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, ThinWedge attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `thinwedge_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableThinWedgeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ThinWedgeErrorInfo(
    RootModel[
        ThinWedgeErrorInfoValue
        | HttpConnectionFailedThinWedgeErrorInfo
        | ResponseStreamConnectionFailedThinWedgeErrorInfo
        | ResponseStreamDisconnectedThinWedgeErrorInfo
        | ResponseTooManyFailedAttemptsThinWedgeErrorInfo
        | ActiveTurnNotSteerableThinWedgeErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class TurnError(BaseModel):
    ...
    thinwedge_error_info: Annotated[ThinWedgeErrorInfo | None, Field(alias="thinwedgeErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `thinwedge`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, thinwedge exec, thinwedge app-server, etc.)."
        ),
    ]
