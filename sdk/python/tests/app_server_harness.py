...
from openai_thinwedge import ThinWedgeConfig
...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_openai_auth: bool = False) -> None:
        ...
        self.thinwedge_home = tmp_path / "thinwedge-home"
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.thinwedge_home, ignore_errors=True)
        shutil.rmtree(self.workspace, ignore_errors=True)

    def app_server_config(self) -> ThinWedgeConfig:
        """Build SDK config for an isolated pinned-runtime app-server process."""
        return ThinWedgeConfig(
            cwd=str(self.workspace),
            env={
                "THINWEDGE_HOME": str(self.thinwedge_home),
                "THINWEDGE_APP_SERVER_DISABLE_MANAGED_CONFIG": "1",
                "RUST_LOG": "warn",
            },
        )
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.thinwedge_home / "config.toml"
