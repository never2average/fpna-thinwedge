...
import openai_thinwedge.api as public_api_module
from openai_thinwedge.api import (
    ApprovalMode,
    AsyncThinWedge,
    ThinWedge,
    Sandbox,
)
from openai_thinwedge.generated.v2_all import TurnStartParams
from openai_thinwedge.models import InitializeResponse
...
def test_thinwedge_init_failure_closes_client(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(public_api_module, "ThinWedgeClient", FakeClient)
