...
GENERATED_TARGETS = [
    Path("src/openai_thinwedge/generated/notification_registry.py"),
    Path("src/openai_thinwedge/generated/v2_all.py"),
    Path("src/openai_thinwedge/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("openai-thinwedge-cli-bin") == "0.137.0a4"
    env = os.environ.copy()
    env.pop("THINWEDGE_EXEC_PATH", None)
