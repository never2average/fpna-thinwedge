...
from openai_thinwedge import ThinWedge, ImageInput, LocalImageInput, SkillInput, TextInput
...
def test_remote_image_input_reaches_responses_api(
    ...
    remote_image_url = "https://example.com/thinwedge.png"
    ...
    with AppServerHarness(tmp_path) as harness:
        ...
        with ThinWedge(config=harness.app_server_config()) as thinwedge:
            result = thinwedge.thread_start().run(
                [
