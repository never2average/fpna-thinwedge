...
from openai_thinwedge.client import ThinWedgeClient, _params_dict
...
from openai_thinwedge.models import Notification, UnknownNotification
...
def test_generated_v2_bundle_has_single_shared_plan_type_definition() -> None:
    source = (ROOT / "src" / "openai_thinwedge" / "generated" / "v2_all.py").read_text()
